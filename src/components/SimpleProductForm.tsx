...
export function SimpleProductForm({ initialProduct, allProducts, onSave, onCancel }: SimpleProductFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const productToSave: Product = {
      ...
      // Clear out legacy arrays to prevent confusion
      variants: [],
      inventorySkus: [],
      productOptions: []
    };
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="space-y-4">
          <div className="border-b pb-2 border-default">
            ...
            <p className="text-[10px] text-muted mt-0.5">Colors do not affect price or stock. They are labels selected during billing.</p>
          </div>
